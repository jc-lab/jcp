...
#include "jcp/internal/asn1_types/EncryptedPrivateKeyInfo.h"
...
static asn_TYPE_member_t asn_MBR_EncryptedPrivateKeyInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EncryptedPrivateKeyInfo, encryptionAlgorithm),
		...
		&asn_DEF_EncryptionAlgorithmIdentifier,
...
static const ber_tlv_tag_t asn_DEF_EncryptedPrivateKeyInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_EncryptedPrivateKeyInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* encryptionAlgorithm */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* encryptedData */
};
...
asn_TYPE_descriptor_t asn_DEF_EncryptedPrivateKeyInfo = {
	...
	asn_DEF_EncryptedPrivateKeyInfo_tags_1,
	sizeof(asn_DEF_EncryptedPrivateKeyInfo_tags_1)
		/sizeof(asn_DEF_EncryptedPrivateKeyInfo_tags_1[0]), /* 1 */
	asn_DEF_EncryptedPrivateKeyInfo_tags_1,	/* Same as above */
	sizeof(asn_DEF_EncryptedPrivateKeyInfo_tags_1)
		/sizeof(asn_DEF_EncryptedPrivateKeyInfo_tags_1[0]), /* 1 */
